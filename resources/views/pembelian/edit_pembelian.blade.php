        ...
        <form action="{{ route('pembelian.update', $pembelian->id) }}" method="POST" id="form-pembelian">
            ...
            <div class="form-group">
                ...
                <select name="supplier_id" id="supplier_id" class="form-control select2" onchange="handleSupplierChange()">
                    <option value="{{ $pembelian->supplier->id ?? '' }}">{{ $pembelian->supplier->nama ?? '--Pilih Supplier--'}}</option>
                ...
                <table class="table table-striped mt-3" id="daftar-barang">
                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach($pembelian->pembelianBarang as $detail)
                            <tr data-barang-id="{{ $detail->barang_id }}">
                                ...
                                <td>
                                    ...
                                    <span class="jumlah-display">{{ $detail->jumlah }}</span>
